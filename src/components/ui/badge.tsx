...
const badge = tv({
  base: "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 m-1 border-foreground/10 text-foreground bg-card hover:bg-card/80",
  variants: {
    variant: {
      default:
